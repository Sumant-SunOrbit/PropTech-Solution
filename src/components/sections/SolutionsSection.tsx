...
//       {/* Background Blobs */}
//        <div className="absolute -top-32 -left-32 h-100 w-100 rounded-full bg-orange-200/50 blur-2xl" />
//       <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-rose-200/50 blur-3xl" />
...
//           <h2 className="text-3xl md:text-4xl z-50 font-bold text-slate-900 mb-4">
//             Enterprise Solutions for Modern Real Estate Operations
//           </h2>
//           <p className="text-slate-600 max-w-2xl mx-auto">
//             Built to streamline service management across societies, facility teams,
//             and multi-site property portfolios.
//           </p>
//         </div>

//         {/* Grid */}
//         <div className="grid gap-y-14 gap-x-10 sm:grid-cols-2 lg:grid-cols-3">

//           {solutions.map((item, index) => (
//             <div
//               key={index}
//               className="text-center transition-all duration-300 hover:bg-white hover:shadow-xl hover:-translate-y-1 rounded-2xl p-6"
//             >
//               {/* Illustration */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-14 animate-fade-up">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 mb-3 sm:mb-4">
            Enterprise <span className="text-primary">Solutions</span> for Modern Real Estate Operations
          </h2>
