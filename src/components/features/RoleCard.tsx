...
export default function RoleCard({ title, icon: Icon, points }: Props) {
  return (
    <div className="group w-full bg-white rounded-3xl px-10 py-8 shadow-md border border-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl items-center">
      {/* Icon */}
