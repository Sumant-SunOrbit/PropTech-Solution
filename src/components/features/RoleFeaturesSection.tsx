      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16 animate-fade-down">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto text-sm sm:text-base">
            Role-based capabilities designed to simplify operations and improve
            service delivery.
          </p>
        </div>

        {/* Responsive Grid Layout */}
        <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center px-5">
